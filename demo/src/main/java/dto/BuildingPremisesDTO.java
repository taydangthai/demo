...
public class BuildingPremisesDTO {
    ...
    public BuildingPremisesDTO() {
    }

    public BuildingPremisesDTO(Long id, String position, int acreage, Long buildingId, String name, int acreageForRent, int acreageForUse, String note) {
        this.id = id;
